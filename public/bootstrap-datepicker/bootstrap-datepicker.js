! function(t, e) {
    var i = function(t) {
        ...
        231: function(t, e, i) {
             ...
             */
            s = [i(1)], void 0 === (n = "function" == typeof(a = function(t, e) {
                function i() {
                ...
                r.prototype = {
                    ...
                    _resolveViewName: function(e) {
                        return t.each(f.viewModes, function(i, a) {
                    ...
                    _process_options: function(e) {
                        ...
                        if (s.defaultViewDate instanceof Date || "string" == typeof s.defaultViewDate) s.defaultViewDate = f.parseDate(s.defaultViewDate, o, s.language, s.assumeNearbyYear);
                    ...
                    fillMonths: function() {
                        for (var t, e = this._utc_to_local(this.viewDate), i = "", a = 0; a < 12; a++) t = e && e.getMonth() === a ? " focused" : "", i += '<span class="month' + t + '">' + p[this.o.language].monthsShort[a] + "</span>";
                    ...
                    _fill_yearsView: function(i, a, s, n, o, r, h) {
                        for (var l, d, c, u = "", p = s / 10, f = this.picker.find(i), g = Math.floor(n / s) * s, m = g + 9 * p, y = Math.floor(this.viewDate.getFullYear() / p) * p, D = t.map(this.dates, function(t) {
                            return Math.floor(t.getUTCFullYear() / p) * p
                        }), v = g - p; v <= m + p; v += p) l = [a], d = null, v === g - p ? l.push("old") : v === m + p && l.push("new"), -1 !== t.inArray(v, D) && l.push("active"), (v < o || v > r) && l.push("disabled"), v === y && l.push("focused"), h !== t.noop && ((c = h(new Date(v, 0, 1))) === e ? c = {} : "boolean" == typeof c ? c = {
                            enabled: c
                        } : "string" == typeof c && (c = {
                            classes: c
                    ...
                    fill: function() {
                        ...
                        if (!isNaN(o) && !isNaN(r)) {
                            this.picker.find(".datepicker-days .datepicker-switch").text(f.formatDate(n, m, this.o.language)), this.picker.find("tfoot .today").text(u).css("display", !0 === this.o.todayBtn || "linked" === this.o.todayBtn ? "table-cell" : "none"), this.picker.find("tfoot .clear").text(g).css("display", !0 === this.o.clearBtn ? "table-cell" : "none"), this.picker.find("thead .datepicker-title").text(this.o.title).css("display", "string" == typeof this.o.title && "" !== this.o.title ? "table-cell" : "none"), this.updateNavArrows(), this.fillMonths();
                            var y = i(o, r, 0),
                                D = y.getUTCDate();
                            y.setUTCDate(D - (y.getUTCDay() - this.o.weekStart + 7) % 7);
                            var v = new Date(y);
                            y.getUTCFullYear() < 100 && v.setUTCFullYear(y.getUTCFullYear()), v.setUTCDate(v.getUTCDate() + 42), v = v.valueOf();
                            for (var w, k, b = []; y.valueOf() < v;) {
                                if ((w = y.getUTCDay()) === this.o.weekStart && (b.push("<tr>"), this.o.calendarWeeks)) {
                                    var _ = new Date(+y + (this.o.weekStart - w - 7) % 7 * 864e5),
                                ...
                                }(k = this.getClassNames(y)).push("day");
                                var U = y.getUTCDate();
                                this.o.beforeShowDay !== t.noop && ((s = this.o.beforeShowDay(this._utc_to_local(y))) === e ? s = {} : "boolean" == typeof s ? s = {
                                    enabled: s
                                } : "string" == typeof s && (s = {
                                    classes: s
                                }), !1 === s.enabled && k.push("disabled"), s.classes && (k = k.concat(s.classes.split(/\s+/))), s.tooltip && (a = s.tooltip), s.content && (U = s.content)), k = t.isFunction(t.uniqueSort) ? t.uniqueSort(k) : t.unique(k), b.push('<td class="' + k.join(" ") + '"' + (a ? ' title="' + a + '"' : "") + ' data-date="' + y.getTime().toString() + '">' + U + "</td>"), a = null, w === this.o.weekEnd && b.push("</tr>"), y.setUTCDate(y.getUTCDate() + 1)
                            }
                            this.picker.find(".datepicker-days tbody").html(b.join(""));
                            var x = p[this.o.language].monthsTitle || p.en.monthsTitle || "Months",
                                S = this.picker.find(".datepicker-months").find(".datepicker-switch").text(this.o.maxViewMode < 2 ? x : o).end().find("tbody span").removeClass("active");
                            if (t.each(this.dates, function(t, e) {
                                e.getUTCFullYear() === o && S.eq(e.getUTCMonth()).addClass("active")
                            }), (o < h || o > d) && S.addClass("disabled"), o === h && S.slice(0, l).addClass("disabled"), o === d && S.slice(c + 1).addClass("disabled"), this.o.beforeShowMonth !== t.noop) {
                                var V = this;
                                t.each(S, function(i, a) {
                                    var s = new Date(o, i, 1),
                                        n = V.o.beforeShowMonth(s);
                            ...
                            this._fill_yearsView(".datepicker-years", "year", 10, o, h, d, this.o.beforeShowYear), this._fill_yearsView(".datepicker-decades", "decade", 100, o, h, d, this.o.beforeShowDecade), this._fill_yearsView(".datepicker-centuries", "century", 1e3, o, h, d, this.o.beforeShowCentury)
                        }
                    },
                    ...
                    navArrowsClick: function(e) {
                        ...
                        0 !== this.viewMode && (a *= 12 * f.viewModes[this.viewMode].navStep), this.viewDate = this.moveMonth(this.viewDate, a), this._trigger(f.viewModes[this.viewMode].e, this.viewDate), this.fill()
                    },
                    ...
                    moveMonth: function(t, e) {
                        ...
                        if (e = e > 0 ? 1 : -1, 1 === r) a = -1 === e ? function() {
                            ...
                            for (var h = 0; h < r; h++) s = this.moveMonth(s, e);
                            ...
                            if (a !== e) {
                                ...
                                if (-1 !== o) {
                                    if (t.each(this.pickers, function(t, e) {
                                        ...
                                        for (; h < l && s > this.dates[h];) this.pickers[h++].setUTCDate(s);
                        ...
                        if (s.shift(), this.each(function() {
                            ...
                            if (!n) {
                                var l = function(e, i) {
                                        ...
                                        for (var h in i = new RegExp("^" + i.toLowerCase()), s) i.test(h) && (a = h.replace(o, r), n[a] = s[h]);
                                        return n
                                    }(this, "date"),
                                    d = t.extend({}, c, l, o),
                                    f = function(e) {
                                ...
                                }), n = new h(this, g)) : n = new r(this, g), e.data("datepicker", n)
                            }
                ...
                var p = t.fn.datepicker.dates = {
                    ...
                    f = {
                        ...
                        parseDate: function(i, s, n, o) {
                            ...
                            if ("string" == typeof s && (s = f.parseFormat(s)), s.toValue) return s.toValue(i, s, n);
                            var h, l, d, c, u, g = {
                                    d: "moveDay",
                                    m: "moveMonth",
                                    w: "moveWeek",
                            ...
                            if (i in m && (i = m[i]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(i)) {
                                for (h = i.match(/([\-+]\d+)([dmwy])/gi), i = new Date, c = 0; c < h.length; c++) l = h[c].match(/([\-+]\d+)([dmwy])/i), d = Number(l[1]), u = g[l[2].toLowerCase()], i = r.prototype[u](i, d);
                                return r.prototype._zero_utc_time(i)
                            }
                            ...
                            }).toArray()), h.length === b.length) {
                                var C, T, M;
                                for (c = 0, C = b.length; c < C; c++) {
                                    if (y = parseInt(h[c], 10), l = b[c], isNaN(y)) switch (l) {
                                        case "MM":
                                            D = t(p[n].months).filter(_), y = t.inArray(D[0], p[n].months) + 1;
                                            break;
                                        case "M":
                                            D = t(p[n].monthsShort).filter(_), y = t.inArray(D[0], p[n].monthsShort) + 1
                                    }
                                    v[l] = y
                                }
    ...
    if ("object" == typeof i) {
        ...
        for (var s in i) a[0] && (a[0][s] = i[s]), a[1] && "__esModule" !== s && (a[1][s] = i[s]), a[2] && (a[2][s] = i[s])
    }
}(this);