...
<head>
    ...
    <style>
        ...
        @media all {
            ...
            .bg-lime{
                background: linear-gradient(87deg, #2ac4f4 0, #bcd630 100%) !important;
            }
    </style>
</head>
<body class="">
<table border="0" cellpadding="0" cellspacing="0" class="body">
    <tr>
        <td class="container cn-logo">
            <img class="logo-dx" src="{{
            url('logo_bahana_dx_trade.png')
            }}" width="70px"
                 height="70px">
        </td>
    </tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="body">
    ...
    <tr>
        <td class="container" style="text-align: center;color:#777777;font-size: 12px;padding-top: 15px;">
            The DX-TRADE Team<br>
            &copy; DX-Trade 2020. All Rights Reserved.
        </td>
    </tr>
</table>
</body>
